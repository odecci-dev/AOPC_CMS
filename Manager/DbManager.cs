...
namespace AuthSystem.Manager
{
    public class DbManager
    {
        ...
        public void ConnectioStr()
        {
            ...
            //cnnstr = "Data Source=EC2AMAZ-2PRMHQI;Database=AOPCDB;User ID=test;Password=1234";//aopc live
            //cnnstr = "Data Source=EC2AMAZ-2PRMHQI;Database=AOPCDB;User ID=test;Password=1234";//aopc live
            //cnnstr = "Data Source=EC2AMAZ-2PRMHQI;Initial Catalog=AOPCDB_STAGING;User ID=test;Password=1234"; // aopc staging server
            //cnnstr = "Data Source=EC2AMAZ-V52FJK1;Database=AOPCDB;User ID=test;Password=1234"; 
